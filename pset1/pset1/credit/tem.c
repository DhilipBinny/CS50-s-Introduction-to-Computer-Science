...
// long long n,i,j,t;
// int count,sum,sum_2,m,k,z,y,x,w,v,s;
// int array[100], a_array[100],b_array[100],un_array[100];

long long card_no,i,j,t;
int count,k,s,n,m,x,y,z,v,u,sum,sum_2,total_sum;
